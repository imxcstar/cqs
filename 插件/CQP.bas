...
Public Const CQAPPID = "com.xcssa.cqs"

Public Const EVENT_IGNORE = 0        '事件_忽略
Public Const EVENT_BLOCK = 1         '事件_拦截

Public Const REQUEST_ALLOW = 1       '请求_通过
Public Const REQUEST_DENY = 2        '请求_拒绝

Public Const REQUEST_GROUPADD = 1    '请求_群添加
Public Const REQUEST_GROUPINVITE = 2 '请求_群邀请

Public Const CQLOG_DEBUG = 0         '调试 灰色
Public Const CQLOG_INFO = 10         '信息 黑色
Public Const CQLOG_INFOSUCCESS = 11  '信息(成功) 紫色
Public Const CQLOG_INFORECV = 12     '信息(接收) 蓝色
Public Const CQLOG_INFOSEND = 13     '信息(发送) 绿色
Public Const CQLOG_WARNING = 20      '警告 橙色
Public Const CQLOG_ERROR = 30        '错误 红色
Public Const CQLOG_FATAL = 40        '致命错误 深红
